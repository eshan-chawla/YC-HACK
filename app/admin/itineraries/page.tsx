      ...
      <div className="space-y-8">
        ...
        {isLoading ? (
          ...
          <Card className="p-12 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-6">Create your first travel event to get started.</p>
            <Link href="/admin/itineraries/new">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-6 border-t border-border/60">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm font-bold">{event.employeeIds.length}</p>
                            </div>
                          </div>
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-full bg-muted flex items-center justify-center">
                            ...
                            <div>
                              ...
                              <p className="text-sm font-bold">{event.bookedCount}</p>
                            </div>
                          </div>
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-full bg-muted flex items-center justify-center">
                            ...
                            <div>
                              ...
                              <p className="text-sm font-bold">${event.totalSpent.toLocaleString()}</p>
                            </div>
                          </div>
