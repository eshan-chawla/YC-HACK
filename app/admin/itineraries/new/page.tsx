          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <Card className="p-6 border-border/60 shadow-sm">
                    ...
                    <div className="space-y-6">
                        <div className="grid gap-2">
                            <Label htmlFor="eventName" className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Event Name</Label>
                            <Input
                                id="eventName"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="grid gap-2">
                                <Label htmlFor="eventDate" className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Date</Label>
                                <Input
                                    id="eventDate"
                                    type="date"
                                    value={eventDate}
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="eventTime" className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-2">
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="restrictions" className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Additional Notes / Restrictions</Label>
                            <Textarea
                                id="restrictions"
                    ...
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex gap-2">
                            <Button
                                ...
                                size="sm"
                                onClick={selectAll}
                                className="text-xs font-bold uppercase tracking-widest text-primary hover:text-primary hover:bg-primary/5"
                            >
                                Select All
                            </Button>
                            <Button
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center justify-between mb-0.5">
                                    ...
                                    <span className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/60">{employee.team}</span>
                                </div>
            ...
            <div className="space-y-6">
                ...
                <Card className="p-6 border-border/60 shadow-sm sticky top-24">
                    ...
                    <div className="space-y-6">
                        <div className="grid gap-2">
                            <Label htmlFor="budgetPerPerson" className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Budget Per Person</Label>
                        ...
                        <div className="space-y-3 pt-4">
                            <Button
                                ...
                                className="w-full h-12 bg-primary hover:bg-green-600 text-primary-foreground font-bold shadow-lg shadow-green-500/10"
                            >
                                {isSubmitting ? (
                                    <>
        ...
        <Dialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
          <DialogContent className="sm:max-w-[500px] rounded-2xl overflow-hidden p-0 border-none shadow-2xl">
            <div className="p-8 text-center space-y-6">
              <div className="mx-auto w-20 h-20 rounded-full bg-green-50 flex items-center justify-center mb-2">
                <CheckCircle2 className="w-10 h-10 text-green-500" />
              </div>
              
              <div className="space-y-2">
                <h2 className="text-2xl font-black text-foreground uppercase tracking-tight">Event Ready!</h2>
              ...
              {successData && (
                <div className="bg-muted/30 rounded-2xl p-6 space-y-4 border border-border/40">
                  <div className="flex items-center justify-between text-sm">
                    <span className="font-bold text-muted-foreground/60 uppercase tracking-widest text-[10px]">Event Name</span>
                    <span className="font-bold text-foreground truncate max-w-[200px]">{successData.eventName}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="font-bold text-muted-foreground/60 uppercase tracking-widest text-[10px]">Participants</span>
                  ...
                  <div className="flex items-center justify-between text-sm border-t border-border/40 pt-4">
                    <span className="font-bold text-muted-foreground/60 uppercase tracking-widest text-[10px]">Total Allocation</span>
